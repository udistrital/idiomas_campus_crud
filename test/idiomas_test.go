...
func run_bee() {
	parametros := "IDIOMAS_CAMPUS_CRUD_HTTP_PORT=" + beego.AppConfig.String("httpport") + " IDIOMAS_CAMPUS_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " IDIOMAS_CAMPUS_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " IDIOMAS_CAMPUS_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " IDIOMAS_CAMPUS_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " IDIOMAS_CAMPUS_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
